...
<div class="menu-ordenes ">
  <table  >
    <td class="strong-rose menu-mensajeria-td">Mis Ordenes</td>
    <td>|</td>
      <td class="menu-mensajeria-td"> <a href="<?= base_url('/ordenes/index2') ?>">  Compartidas Conmigo </a></td>
        ...
        <?php foreach ($ordenes as $orden){ ?>
          ...
          <tr>
            ...
            <td class="td_centrado">
              ...
              <div class="btn-group btn-group-sm" role="group" aria-label="...">
                  <button type="button" class="btn btn-rose" title="Eliminar Orden" onclick="eliminar_orden(<?=  $orden -> id_orden  ?>);"><i class="fas fa-ban blanco"></i></button>
              </div>
            </td>
          </tr>
  ...
  Swal({
    ...
    if (result.value) {
      $.ajax({
        ...
        url: baseUrl+"/ordenes/eliminar_orden/"+id,
        success: function(result) {
          ...
          Swal(
            'Error',
            'Hubo un fallo al eliminar orden',
            'error'
          )
        }
      });
